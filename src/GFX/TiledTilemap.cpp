...
void TiledTilemap::load(ResourceManager* resource,
...
void TiledTilemap::loadVertices(bool autotile)
{
	mVertices.clear();
...
void TiledTilemap::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
